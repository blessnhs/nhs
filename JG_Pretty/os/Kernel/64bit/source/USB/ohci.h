...
and status information associated with star t-of-frame processing.
...
typedef struct
{
    ...
    volatile uint32_t  toggle             :  1;  // toggle // This 2-bit field is used to generate/compare the data PID value (DATA0 or DATA1).
                                                           // The MSb of this field is 占�0占� when the data toggle value is acquired from the toggleCarry field in the ED
    volatile uint32_t  toggleFromTD       :  1;            // and 占�1占� when the data toggle value is taken from the LSb of this field
