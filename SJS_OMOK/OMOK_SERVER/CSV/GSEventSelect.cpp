...
BOOL GSEventSelect::Initialize(SOCKET socket)
{
	...
	m_SelectThreadHandle		= CreateThread(NULL, 0, ::SelectThreadCallback, this, 0, &SelectThreadID);
...
BOOL GSEventSelect::Termination(VOID)
{
	...
	m_SelectThreadHandle = m_StartupEventHandle = m_DestroyEventHandle = m_SelectEventHandle = NULL;
